...
// 	// ========== ATTACK DEMONSTRATION: DH Key ID Tampering ==========
// 	LOG_INF("==========================================================");
// 	LOG_INF("          ATTACK DEMONSTRATION: Key ID Tampering");
// 	LOG_INF("==========================================================");
// 	LOG_INF("[ATTACKER] Can see DH Key ID in non-secure world:");
// 	LOG_INF("           Original DH Key ID = 0x%08x", dh_key_id);
// 	LOG_INF("[ATTACKER] Key ID is just an OPAQUE HANDLE (4 bytes)");
// 	LOG_INF("           NOT related to actual 32-byte DH key material");
// 	LOG_INF("           Actual DH key is stored in SECURE PARTITION");
// 	LOG_INF("");
// 	LOG_INF("[ATTACKER] Now attempting to MODIFY key ID...");
// 	LOG_INF("           Goal: Try to complete pairing with wrong key ID");
// 	LOG_INF("           Hope: Extract keys or disrupt pairing");

// 	// Save original for reference
// 	uint32_t original_dh_key_id = dh_key_id;

// 	// ATTACK: Modify the DH key ID
// 	dh_key_id = 0xDEADBEEF;  // Tamper with arbitrary value
// 	// dh_key_id = original_dh_key_id + 1000;  // Or try incrementing
// 	// dh_key_id = 0x40000001;  // Or try old connection's key ID

// 	LOG_INF("");
// 	LOG_INF("[ATTACK] ✗ TAMPERED: 0x%08x → 0x%08x", original_dh_key_id, dh_key_id);
// 	LOG_INF("[ATTACK] Now using TAMPERED key ID for pairing...");
// 	LOG_INF("==========================================================");
// 	LOG_INF("");

// 	LOG_INF("[SMP] Calling F5 with TAMPERED DH Key ID = 0x%08x...", dh_key_id);
...
// 	if (status != PSA_SUCCESS) {
// 		LOG_ERR("[SMP] ✗ F5 FAILED with tampered key ID: %d", status);
// 		LOG_INF("");
// 		LOG_INF("==========================================================");
// 		LOG_INF("          ATTACK DEMONSTRATION RESULT");
// 		LOG_INF("==========================================================");
// 		LOG_INF("[RESULT] F5 operation FAILED with tampered key ID");
// 		LOG_INF("         Secure partition REJECTED invalid key ID");
// 		LOG_INF("         Pairing will FAIL (DoS achieved)");
// 		LOG_INF("         NO cryptographic keys leaked");
// 		LOG_INF("==========================================================");
// 		LOG_INF("[CONCLUSION] ✓ SECURE DESIGN WORKS!");
// 		LOG_INF("             - Key IDs are validated by secure partition");
// 		LOG_INF("             - Tampering causes DoS, NOT key leakage");
// 		LOG_INF("             - Attacker gains NOTHING from modifying key IDs");
// 		LOG_INF("==========================================================");
// 		return BT_SMP_ERR_UNSPECIFIED;
// 	}
// 	LOG_INF("[SMP] F5 result with tampered ID: status = %d", status);

// 	// Retrieve LTK from secure partition for controller
// 	LOG_INF("[SMP] Calling GET_LTK with TAMPERED DH Key ID = 0x%08x...", dh_key_id);
// 	status = dp_ble_get_ltk(dh_key_id, smp->tk);
// 	if (status != PSA_SUCCESS) {
// 		LOG_ERR("[SMP] ✗ GET_LTK FAILED with tampered key ID: %d", status);
// 		LOG_INF("");
// 		LOG_INF("==========================================================");
// 		LOG_INF("          ATTACK DEMONSTRATION RESULT");
// 		LOG_INF("==========================================================");
// 		LOG_INF("[RESULT] GET_LTK operation FAILED with tampered key ID");
// 		LOG_INF("         Secure partition REJECTED invalid key ID");
// 		LOG_INF("         Pairing will FAIL (DoS achieved)");
// 		LOG_INF("         NO cryptographic keys leaked");
// 		LOG_INF("==========================================================");
...
// 		return BT_SMP_ERR_UNSPECIFIED;
// 	}
// 	LOG_INF("[SMP] GET_LTK result with tampered ID: status = %d", status);
// 	LOG_HEXDUMP_INF(smp->tk, 16, "[SMP] Retrieved LTK (16 bytes):");
